...
void bn_backward_param_gpu(const float* dY,const float* X_,float* dg,float* db,int n,int c,int s);
void bn_backward_gpu(const float* dY,const float* X_,const float* var,const float* g,float* dX,const float* dg,const float* db,int n,int c,int s,float e);
